...
import main.java.strategy.domain.Arena;
import main.java.strategy.domain.Knight;
import main.java.strategy.domain.Weapons;
import main.java.strategy.option.ArchValidator;
import main.java.strategy.option.KnightValidator;
import main.java.strategy.option.MaleKnightsValidator;
import main.java.strategy.option.OldKnightsValidator;
